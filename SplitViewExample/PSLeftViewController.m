...
@interface PSLeftViewController ()
...
- (void)viewDidLoad
{
    ...
    [countries addObject:@"Thailand"];
    [countries addObject:@"USA"];
    [countries addObject:@"Japan"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
     ...
     */
    [self.delegate leftView:self didSelectCountry:[self.countries objectAtIndex:indexPath.row]];
}
